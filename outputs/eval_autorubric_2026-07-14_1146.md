...
**v2 brief:** brief_v2_2026-07-14_1120.md
...
| Data Grounding & Source Citation     | 16% | 4/5 | 5/5 | 3/5 |
...
| Trend & Continuity                   | 12% | 4/5 | 1/5 | 4/5 |
...
|--|:--:|:--:|:--:|
| AutoRubric result.score        | 0.875 | 0.903 | 0.159 |
| **Final Score / 100**          | **87.5** | **90.3** | **15.9** |

- **v2 vs v1**: -2.8 pts
- **v2 vs General**: +71.6 pts
- **v1 vs General**: +74.4 pts

**Token usage:** v2 Agent: 378454 / v1 Agent: 228441 / General LLM: 176183

---

## v2 Improvement Targets

- **penalty: unsupported_number**: The brief contains multiple material quantitative figures that cannot be traced to named sources or shown calculations. Most notably: (1) 'UAE fiscal breakeven: ~$55.00/bbl (IMF estimate)' — cited as 
